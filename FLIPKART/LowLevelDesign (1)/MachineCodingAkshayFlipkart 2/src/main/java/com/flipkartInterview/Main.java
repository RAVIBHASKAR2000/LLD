...
//        restaurantService.addRestaurant(restaurant1);
        ...
        executorService.addCommand("0,ONBOARD_RESTAURANT,rest1,2,Menu,Burger,100,Fries,40,Inventory,Burger,5,Fries,5");
        executorService.addCommand("1,PLACE_ORDER,order3,Fries,Burger,Burger");
        executorService.addCommand("1,SHOW_MENU,rest2");
        executorService.addCommand("1,UPDATE_ITEM_NAME,rest2,Cold Drink,Coke Cola");
        executorService.addCommand("1,SHOW_MENU,rest2");
        executorService.addCommand("2,UPDATE_PRICE,rest1,Burger,200");
        executorService.addCommand("3,PLACE_ORDER,order1,Burger");
        executorService.addCommand("3,PLACE_ORDER,order99,invalid");
        executorService.addCommand("4,PLACE_ORDER,order4,Burger");
        executorService.addCommand("5,PLACE_ORDER,order3,Fries");
        executorService.addCommand("5,PLACE_ORDER,order2,Burger,Fries");
        executorService.addCommand("8,DISPATCH_ORDER,order1");
        executorService.addCommand("9,SHOW_DISPATCH_ORDER");
